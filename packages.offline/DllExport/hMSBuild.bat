...
:bw
echo.
@echo hMSBuild - 2.2.0.5861+2465d90
...
set "a9=" & set "a_="
for /F "usebackq tokens=1* delims=: " %%a in (`"!a4!" -nologo !a6! -products * -requires !a8! Microsoft.Component.MSBuild`) do (
